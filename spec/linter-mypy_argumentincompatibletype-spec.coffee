  ...
  describe "reads bad0.py and", ->
    ...
    describe "validates reported warnings", ->
      ...
      it 'should have put the good range base on heuristic', ->
        ...
        expect(messages[2].location.position).toEqual([[3,0],[3,0]])
        ...
        expect(messages[15].location.position).toEqual([[10,0],[10,3]])
        expect(messages[16].location.position).toEqual([[10,0],[10,3]])
        expect(messages[17].location.position).toEqual([[10,0],[10,0]])
